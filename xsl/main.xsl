...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:include href="error-templates.xsl"/>
    <xsl:include href="debug.xsl"/>

    <!-- include component XSLs -->
    <xsl:include href="../components/core/xsl/main.xsl"/>
    <xsl:include href="../components/cms/xsl/main.xsl"/>
    <xsl:include href="../components/forum/xsl/main.xsl"/>
    <xsl:include href="../components/shop/xsl/main.xsl"/>
    <xsl:include href="../components/store/xsl/main.xsl"/>
    <xsl:include href="../components/statistics/xsl/main.xsl"/>
